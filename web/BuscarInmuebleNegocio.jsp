<%-- 
    Document   : BuscarInmuebleNegocio
    Created on : 29/04/2015, 04:52:07 PM
    Author     : KMILO
--%>
    ...
    <body>
        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
            <form role="form" action="ControladorInmueble">
                ...
                <h2>Buscar Inmuebles Disponibles</h2>
                <hr class="colorgraph">                 
		...
		<hr class="colorgraph">
		<div class="row">
                    <div class="col-xs-6 col-md-6"><input type="submit" value="BuscarNegocio" name="btn_aceptar" class="btn btn-success btn-block btn-lg" tabindex="7"></div>
